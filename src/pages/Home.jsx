...
const samplePlatesByRestaurant = {
  "Katsu Midori": [
    { id: "km-01", price: 40, calories: 90, color_name: "🔴 สีแดง", emoji: "🔴", color_hex: "#ef4444", image: km01 },
    { id: "km-02", price: 50, calories: 105, color_name: "🔵 สีน้ำเงิน", emoji: "🔵", color_hex: "#3b82f6", image: km02 },
    { id: "km-03", price: 60, calories: 120, color_name: "🟢 สีเขียว", emoji: "🟢", color_hex: "#10b981", image: km03 },
    { id: "km-04", price: 70, calories: 135, color_name: "🟡 สีเหลือง", emoji: "🟡", color_hex: "#f59e0b", image: km04 },
    { id: "km-05", price: 80, calories: 150, color_name: "🟤 สีน้ำตาล", emoji: "🟤", color_hex: "#8b5e3c", image: km05 },
    { id: "km-06", price: 90, calories: 165, color_name: "⚪ สีขาว", emoji: "⚪", color_hex: "#ffffff", image: km06 },
    { id: "km-07", price: 100, calories: 180, color_name: "🟪 สีม่วง", emoji: "🟪", color_hex: "#7c3aed", image: km07 },
    { id: "km-08", price: 110, calories: 195, color_name: "🧡 สีส้ม", emoji: "🧡", color_hex: "#f97316", image: km08 },
    { id: "km-09", price: 120, calories: 210, color_name: "🩶 สีเงิน", emoji: "🩶", color_hex: "#9ca3af", image: km09 },
    { id: "km-10", price: 140, calories: 240, color_name: "🪙 สีทอง", emoji: "🪙", color_hex: "#d4af37", image: km10 },
    { id: "km-11", price: 160, calories: 270, color_name: "🌟 ลายทอง / ลายพิเศษ", emoji: "🌟", color_hex: "#fbbf24", image: km11 },
    { id: "km-12", price: 180, calories: 300, color_name: "⚫ สีดำ", emoji: "⚫", color_hex: "#000000", image: km12 },
  ],
  SUSHIRO: [
    { id: "ss-01", price: 40, calories: 100, color_name: "🔴 จานสีแดง (เมนูเบสิก: แซลมอน, ทูน่า)", emoji: "🔴", color_hex: "#ef4444", image: ss01 },
    { id: "ss-02", price: 60, calories: 160, color_name: "🪙 จานสีเงิน (เมนูอัปเกรด: โฮตาเตะ, เนื้อวัว)", emoji: "🪙", color_hex: "#9ca3af", image: ss02 },
    { id: "ss-03", price: 80, calories: 220, color_name: "🟡 จานสีทอง (เมนูพรีเมียม: ชูโทโร่, ปลาไหล)", emoji: "🟡", color_hex: "#f59e0b", image: ss03 },
    { id: "ss-04", price: 120, calories: 320, color_name: "⚫ จานสีดำ (เมนูสูงสุด: โอโทโร่, อูนิ)", emoji: "⚫", color_hex: "#000000", image: ss04 },
  ],
};
